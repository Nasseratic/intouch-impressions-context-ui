...
<div
  class="mx-auto h-screen px-6 sm:px-12 flex flex-col-reverse sm:flex-row relative pt-10 z-0"
>
    ...
    <svg
      ...
      ><defs
        ><linearGradient
          ...
          ><stop offset="0" stop-color="#2a2839" /><stop
            offset="1"
            stop-color="#38435d"
          /></linearGradient
        ><linearGradient
        ...
        /><linearGradient
          ...
          y2="149.56"
          gradientUnits="userSpaceOnUse"
          ><stop offset="0" stop-color="#746aa6" /><stop
            offset="0.31"
            stop-color="#5d5298"
          /><stop offset="0.75" stop-color="#423687" /><stop
            offset="1"
            stop-color="#382b81"
          /></linearGradient
        ><linearGradient
        ...
        /><linearGradient
          ...
          ><stop offset="0" stop-color="#eef2fa" /><stop
            offset="0.27"
            stop-color="#e5ecf6"
          /><stop offset="1" stop-color="#d1ddee" /></linearGradient
        ><linearGradient
        ...
        /><linearGradient
          ...
          xlink:href="#linear-gradient-3"
        /></defs
      ><title>men</title><g style="isolation:isolate"
  ...
  >
    <h1 class="text-4xl lg:text-5xl text-blue-900 leading-none mb-4 font-black">
      Intouch Marvin Services
    </h1>
    <p class="lg:text-lg mb-4 sm:mb-12 text-blue-900">
      Beta UI for Some of Intouch Marvin Services
    </p>
  </div>
  <svg
